            ...
            <div class="flex items-center justify-between space-x-4">
              ...
              <div class="min-w-0 space-y-3">
                <div class="flex items-center ">
                  <h2 class="text-sm font-bold text-slate-700">
                    <a href="#">
                      ...
                      Título da vaga <span class="sr-only">Running</span>
                    </a>
                  </h2>
                </div>
                <a href="#" class="relative group flex items-center space-x-2.5">
                  ...
                  <span class="text-sm text-gray-500 group-hover:text-gray-900 font-medium truncate">Nome da Empresa </span>
                </a>
              </div>
              <div class="sm:hidden">
              ...
              <div class="hidden sm:flex flex-col flex-shrink-0 items-end space-y-3">
                <p class="flex items-center space-x-4">
                  <a href="#" class="relative text-sm text-slate-700 font-bold"> R$ 2.000 </a>
                </p>
