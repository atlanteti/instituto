<nav class="bg-white border-t border-gray-200 px-4 pb-5 flex items-center justify-between sm:px-0">
  <div class="-mt-px w-0 flex-1 flex">
    <a href="#" class="border-t-2 border-transparent pt-4 pr-1 pl-4 inline-flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">
  ...
  <div class="hidden md:-mt-px md:flex">
    ...
    <a href="#" class="border-purple-900 text-purple-900 border-t-2 pt-4 px-4 inline-flex items-center text-sm font-medium" aria-current="page"> 2 </a>
  ...
  <div class="-mt-px w-0 flex-1 flex justify-end">
    <a href="#" class="border-t-2 border-transparent pt-4 pl-1 pr-4 inline-flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">
      Próximo
