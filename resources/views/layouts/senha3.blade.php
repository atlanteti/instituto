            	...
            	<div class="mt-8">
                	...
                	<div class="mt-6">
                    	<form action="#" method="POST" class="space-y-6">
                        	<div>
                            	<label for="email" class="block text-sm font-medium text-white"> Nova senha </label>
                            	<div class="mt-1">
                        	...
                        	<div class="space-y-1">
                            	<label for="password" class="block text-sm font-medium text-white"> Confirmar senha </label>
        	                    <div class="mt-1">
