                    	...
                    	<form action="#" method="POST" class="space-y-6">
                        	...
                        	<div class="flex items-center justify-between">
                            	<div class="flex items-center">
                                	...
                                	<label for="remember-me" class="block ml-2 text-sm text-white"> Lembre minha senha! </label>
                            	</div>

                         	   <div class="text-sm">
                                	<a href="#" class="font-medium text-white text-bold"> Esqueci minha senha </a>
                            	</div>
                        	</div>

                        	<div class="pt-5">
                            	<button type="submit" class="flex justify-center w-full px-4 py-2 text-sm font-medium text-white bg-purple-900 border border-transparent rounded-md shadow-sm"><a href="/home">Entrar</a></button>
                        	</div>
